	...
	<header class="header-info">
		<div class="container">
			<div class="row header-inner">
				...
				<div class="col-md-4">	<!--Titre navbar-->	
					<?php
					echo '<h1 class="logo-text"><a href="'. esc_url(home_url( '/' )). '" class="navbar-brand">Sophie <strong style="font-color : #FE4A3E;">cuisine</strong></a></h1>';
					?>
				</div>
				<div class="col-md-4">
